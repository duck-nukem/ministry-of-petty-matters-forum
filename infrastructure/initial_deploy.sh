...
docker build --platform=linux/amd64 -t registry.digitalocean.com/petty-matters/ministry:latest ..
docker build --platform=linux/amd64 -t registry.digitalocean.com/petty-matters/ministry:deps ../migration
